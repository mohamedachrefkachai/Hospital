...
<center>
    <h1 style="color:#4AD489">Manage drugs</h1>
    <style>
        body {
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <form method="POST" action="modifiermedicament.php">
                                <input type="hidden" name="toupdate" value="<?php echo $medicament['id_medicament']; ?>">
                                <button type="submit" name="update">update</button>
                            </form>
                            </td>
                            <td>
                                 <form method="POST" action="deletemedicament.php">
                                <input type="hidden" name="todelete" value="<?php echo $medicament['id_medicament']; ?>">
