...
if(isset($_POST['subb']))
{
    ...
    $Staff=$staffC->showStaff($_GET['auth']);
...
<!DOCTYPE html>
    ...
    <body>
        <form action="" method="post">
            <h2><div class="staff_name">'. $Staff['Nom'] .'  ' . $Staff['Prenom'] . '</div></h2>
            ...
            <table>
                ...
                <tr>
                    <td>E-MAIL:</td>
                    <td>' . $Staff['E_mail'] . '</td>
                    <td><input type="hidden" name="email" value="' . $Staff['E_mail'] . '"></td>
                </tr>
                ...
                <tr>
                    <td>Password:</td>
                    <td>******</td>
                    <td><input type="password" name="password" value="' . $Staff['Password_s'] . '"></td>
                </tr>
            </table>
